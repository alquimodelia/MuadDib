...
Thank you for considering contributing to MuadDib! We appreciate your interest in making this project better.
...
You can contribute to MuadDib in various ways, including but not limited to:

- **Reporting Issues:** If you encounter a bug or have a feature request, please open an issue on our [GitHub Issues](https://github.com/alquimodelia/MuadDib/issues) page.
...
1. **Fork** the MuadDib repository to your GitHub account.

2. **Clone** your forked repository to your local machine.

   ```bash
   git clone https://github.com/your-username/MuadDib.git
   ```
...
8. Commit your changes and push them to your forked repository.
   ```bash
    ...
    ```
9. Create a Pull Request from your fork to the MuadDib repository. Be sure to describe your changes in detail, including references to any relevant issues.
...
Your contributions help make MuadDib better for everyone. We greatly appreciate your time and efforts in helping us improve the project.